...
import faiss
import numpy as np
from transformers import GPT2Tokenizer, GPT2LMHeadModel, AutoTokenizer, AutoModelForCausalLM, AutoModel, pipelines
...
index = faiss.IndexFlatIP(dimension)        # 创建内积距离的平面索引
faiss.normalize_L2(question_embeddings)     # 将向量进行L2标准化
